...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2018 at 11:21 AM
...
--
ALTER TABLE `kelab dan persatuan`
  MODIFY `KodKelab` int(6) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `kelas`
--
ALTER TABLE `kelas`
  MODIFY `KodKelas` int(6) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pendaftaran`
--
ALTER TABLE `pendaftaran`
  MODIFY `KodPendaftaran` int(6) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pengguna`
--
ALTER TABLE `pengguna`
  MODIFY `KodPengguna` int(6) NOT NULL AUTO_INCREMENT;
