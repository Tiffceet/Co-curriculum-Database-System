...
<html>
    ...
    <body>
        <div class="realbody">
            <center>
                <div><img style="border:10px solid rgba(255,255,255,0.5);border-radius:50%;height:10%;" src="image/IndexLogo.JPG" alt="Logo" style="width:200px;height:250px;"></div>
            </center>
            <br>
            <center>
                <div class="menu">
        ...
        <div class="nav-bar" id="nav-bar">
            <img class="icon" src="image/TambahData.png" alt="TambahData">
            <img class="icon" src="image/KemasKini Data.png" alt="KemaskiniData">
            <img class="icon" src="image/hapusData.png" alt="HapusData">
            <img class="icon" src="image/Report.png" alt="Laporan">
        </div>
    </body>
